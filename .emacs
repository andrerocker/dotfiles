...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (json-mode helm-cider cider fancy-battery dockerfile-mode git-timemachine zone-nyan midje-mode ac-cider scala-mode buffer-sets paredit json-reformat rainbow-identifiers nyan-prompt rainbow-blocks 4clojure clojure-mode yaml-mode lua-mode whitespace-cleanup-mode ag go-mode neotree company nyan-mode helm-fuzzy-find helm-projectile helm-ag helm projectile magit solarized-theme))))
